...
public class CardViewRotated extends LinearLayout {
    ...
    public CardViewRotated(Context context, Card card, Player owner) {
        super(context);
        this.card = card;
        this.owner = owner;
        init(context);
    ...
    public CardViewRotated(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CardViewRotated(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        View view = inflater.inflate(R.layout.item_card_rotated, this, true);
